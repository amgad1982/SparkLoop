    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
        <motion.div
          ...
          className="relative w-full max-w-md bg-white dark:bg-[#131b28] border border-slate-200 dark:border-slate-800 rounded-3xl shadow-xl overflow-hidden flex flex-col max-h-[80vh]"
        >
          {/* Header */}
            ...
            {loading ? (
              ...
              users.map((follow) => {
                ...
                return (
                  <div
                    key={follow.id}
                    className="flex items-center justify-between p-3 rounded-2xl bg-slate-50 dark:bg-[#0b0f17] border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-colors"
                  >
                    <div
                      onClick={() => {
